...
CC              = /home/mrnobody/nobodydev/toolchain/clang/aosp/linux-x86/clang-r416183/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= /home/mrnobody/nobodydev/toolchain/clang/aosp/linux-x86/clang-r416183/bin/aarch64-linux-gnu-
